...
class ODConv2d(nn.Module):
    ...
    def _forward_impl_common(self, x):
        ...
        aggregate_weight = torch.sum(aggregate_weight, dim=1) / self.kernel_num  # normalize
        ...
        output = output * filter_attention.expand_as(output)  # fix broadcasting
        return output
    ...
    def _forward_impl_pw1x(self, x):
        ...
        output = output * filter_attention.expand_as(output)
        return output
